...
let womanLength = woman.length;
let numberOfColumn = 4 ;
let numberOfRow = Math.floor((womanLength / numberOfColumn)+1) ; 
var numberOfImage = -1 ;
        ...
        let rows = productsDiv.children[i].innerHTML += `<div class="col-sm-6 col-lg-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="card">
                                            ...
                                            <img id="${woman[numberOfImage].id}" src="./products/woman/${woman[numberOfImage].id}.jpg" alt="imageMissing" class="card-img-top">

                                            <div class="card-body">

                                                <p class="card-title">${woman[numberOfImage].name}</p>
                                                <p class="card-text small">$ ${woman[numberOfImage].price}</p>
