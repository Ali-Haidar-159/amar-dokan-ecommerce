...
let cameraLength = camera.length;
let numberOfColumn = 4 ;
let numberOfRow = Math.floor((cameraLength / numberOfColumn)+1) ; 
var numberOfImage = -1 ;
        ...
        let rows = productsDiv.children[i].innerHTML += `<div class="col-sm-6 col-lg-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="card">
                                            ...
                                            <img id="${camera[numberOfImage].id}" src="./products/camera/${camera[numberOfImage].id}.jpg" alt="imageMissing" class="card-img-top">

                                            <div class="card-body">

                                                <p class="card-title">${camera[numberOfImage].name}</p>
                                                <p class="card-text small">$ ${camera[numberOfImage].price}</p>
